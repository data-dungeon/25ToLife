...
#define RGB_TO_COLOR(r,g,b)     ( 0xFF000000       | (((int)(r))<<16) | (((int)(g))<<8) | ((int)(b)) )
#define RGBA_TO_COLOR(r,g,b,a)  ( (((int)(a))<<24) | (((int)(r))<<16) | (((int)(g))<<8) | ((int)(b)) )
...
#define RGBA_TO_RGBA1555(r,g,b,a) ()(a<<15 | (r)<<11 | (g)<<6 | (b))
