...
class SelectConnectedCommandUIPlugin : public HCommandUIPluginHelper
{
protected:
    HCommandPlugin *m_pSelectConnectedCommandPlugin;

public:
   DECLARE_COMMANDUI_PLUGINHELPER(SelectConnectedCommandUIPlugin, HCommandUIPluginHelper)
