...
del "%SANDBOX_LOG_FILE%"
del "Quazal Rendez-Vous.log"
del "QuazalAuthentication.log"
echo.>>"%SANDBOX_LOG_FILE%"
echo.>>"Quazal Rendez-Vous.log"
echo.>>"QuazalAuthentication.log"
...
:AddSandbox
echo option confirm off >>SandboxCommands.tmp
echo cd %SANDBOX_NAME%/Logs >>SandboxCommands.tmp
echo put "%SANDBOX_LOG_FILE%" >>SandboxCommands.tmp
echo put "Quazal Rendez-Vous.log" >>SandboxCommands.tmp
echo put "QuazalAuthentication.log" >>SandboxCommands.tmp
