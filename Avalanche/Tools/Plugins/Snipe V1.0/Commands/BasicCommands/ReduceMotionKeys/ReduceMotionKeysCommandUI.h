...
class ReduceMotionKeysCommandUIPlugin : public HCommandUIPluginHelper
{
protected:
    HCommandPlugin *m_pReduceMotionKeysCommandPlugin;

public:
   DECLARE_COMMANDUI_PLUGINHELPER(ReduceMotionKeysCommandUIPlugin, HCommandUIPluginHelper)
