...
private:
   ...
   void AddTranslationCurvesConvertFromMayaBoneSpace(KFM::Channel *pChannel,TupperwareAggregate *pAnimChannelPoolAgg,TupperwareAggregate *pAnimSetAgg);
   void AddRotationCurvesConvertFromEuler(KFM::Channel *pChannel,TupperwareAggregate *pAnimChannelPoolAgg);
   void AddScaleCurves(KFM::Channel *pChannel,TupperwareAggregate *pAnimChannelPoolAgg);

   void AddAnimCurve(const char *attributename,KFM::ChannelItem *pChannelItem,TupperwareAggregate *pAnimChannelPoolAgg);
