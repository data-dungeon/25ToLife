 ...
 * 
 * *****************  Version 2  *****************
 * User: Adam Clayton Date: 6/20/03    Time: 4:27p
 * Updated in $/Avalanche/tools/Plugins/Maya/mapAttrib/mapAttribWin32
 * created mapattrib project
 * 
 * *****************  Version 1  *****************
 ...
 * 
 * *****************  Version 4  *****************
 * User: Adam Clayton Date: 2/14/03    Time: 2:14p
 * Updated in $/Avalanche/tools/Plugins/Maya/objAttrib/objAttribWin32
 * notification when opening a file
 * add prefix to custom control creation
 * 
 * *****************  Version 3  *****************
...
#endif
	CustomControls::InitCustomControls(hInstance,"MA"); // Initialize my custom Controls
#if 0
