...
public:
   CExportActionsDialog(){}   // standard constructor
	CExportActionsDialog(ActionCacheContainerHandle *acch);   // standard constructor

   void FillCombo(int id);

   // Dialog Data
   IEModelParms *m_iemp;
   ActionCacheContainerHandle *m_acch;
   String m_dir;
	CCheckListBox	m_checklistbox;
   CList<ActionCacheHandle *, ActionCacheHandle *> m_selected;
