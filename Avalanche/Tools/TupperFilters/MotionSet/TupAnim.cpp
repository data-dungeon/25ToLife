...
void TupAnim::AddChannel(KFM::Channel *pChannel,TupperwareAggregate *pAnimSetAgg)
{
   ...
   AddTranslationCurves(pChannel,pAnimChannelPoolAgg,pAnimSetAgg);
   AddScaleCurves(pChannel,pAnimChannelPoolAgg);
   AddRotationCurves(pChannel,pAnimChannelPoolAgg);
}

void TupAnim::AddTranslationCurves(KFM::Channel *pChannel,TupperwareAggregate *pAnimChannelPoolAgg,TupperwareAggregate *pAnimSetAgg)
{
   TupAnimSet tupAnimSet(pAnimSetAgg);
...
void TupAnim::AddRotationCurves(KFM::Channel *pChannel,TupperwareAggregate *pAnimChannelPoolAgg)
{
