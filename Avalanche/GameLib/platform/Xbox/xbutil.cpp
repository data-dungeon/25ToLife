...
// Desc: Loads the specified file into a newly allocated buffer.  Caller is
//          expected to free the buffer using free().  Note that dwSize is the
//          size of the actual data, which is not necessarily the size of the
//          buffer.
//-----------------------------------------------------------------------------
...
VOID XBUtil_DebugPrint( const char* strMsg, ... )
{
