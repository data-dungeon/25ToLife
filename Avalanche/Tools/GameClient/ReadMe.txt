========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : GameClient
========================================================================


AppWizard has created this GameClient application for you.  This application
...
GameClientDlg.h, GameClientDlg.cpp - the dialog
    ...
    template is in GameClient.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CGameClientDlgAutoProxy class.  This class
