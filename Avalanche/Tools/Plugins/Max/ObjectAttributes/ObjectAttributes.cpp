//-----------------------------------------------------------------------------
//	File:		ObjectAttributes.cpp
//	Created:	Nov. 9, 2001
//				Copyright (c) 2001, Avalanche Software Inc.
//				All Rights Reserved.
//	Author:		Brad Worthen
//
//	Desc:	The ObjectAttributes class acts as the main class for this utility
//			plugin.  It allows the user to set custom attributes at the object
//			level in 3ds Max.  This file contains the ObjectAttributes class
//			and some helper classes and functions.
//
//	History:	11/9/2001: Initial creation - Brad Worthen
//-----------------------------------------------------------------------------
...
#define OBJECTATTRIBUTES_CLASS_ID	Class_ID(0x59457b41, 0x59069386)


//-----------------------------------------------------------------------------
// ObjectAttributesClassDesc Class Declaration:

class ObjectAttributesClassDesc : public ClassDesc2
{
public:
	int 			IsPublic() { return TRUE; }
	void *			Create(BOOL loading = FALSE) { return &theObjectAttributes; }
	const TCHAR *	ClassName() { return GetString(IDS_CLASS_NAME); }
	SClass_ID		SuperClassID() { return UTILITY_CLASS_ID; }
	Class_ID		ClassID() { return OBJECTATTRIBUTES_CLASS_ID; }
	const TCHAR* 	Category() { return GetString(IDS_CATEGORY); }

	// Returns fixed parsable name (scripter-visible name):
	const TCHAR*	InternalName() { return _T("ObjectAttributes"); }
...
static ObjectAttributesClassDesc ObjectAttributesDesc;
ClassDesc2* GetObjectAttributesDesc()
{
	return &ObjectAttributesDesc;
}
...
{
	if (theObjectAttributes.bDialogUp == true)
	{
...
//-----------------------------------------------------------------------------
// ObjectAttributes::BeginEditParams
// This method is called when the user clicks on the Object Attributes button
...
// Output: None.
//-----------------------------------------------------------------------------
void ObjectAttributes::BeginEditParams(Interface* ip,IUtil* iu) 
{
	this->iu = iu;
	this->ip = ip;
	SetupAttributes();
...
void ObjectAttributes::SetupAttributes() 
...
// attributes
{
	...
	if (!hDlg)
	{
		...
		HWND hAncestorWindow = GetAncestor(hActiveWindow,GA_ROOTOWNER);
		hDlg = CreateDialogParam(hInstance, MAKEINTRESOURCE(IDD_OBJECTATTRIB), 
			hAncestorWindow, ObjectAttributesDlgProc,
			(LPARAM) this);
		bDialogUp = true;
	}
	else
...
//-----------------------------------------------------------------------------
// ObjectAttributes::EndEditParams
...
// Output: None.
//-----------------------------------------------------------------------------
void ObjectAttributes::EndEditParams(Interface *ip,IUtil *iu)
{
	this->iu = iu;
}
...
bool ObjectAttributes::DrawUIDisplayLines(HDC hdc)
{
	...
	int topLeft = CustomControls::GetColor(COLOR_BTNSHADOW);
	int bottomRight = CustomControls::GetColor(COLOR_BTNHIGHLIGHT);
