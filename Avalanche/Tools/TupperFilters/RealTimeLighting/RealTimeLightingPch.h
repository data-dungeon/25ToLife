...
#ifndef __REAL_TIME_LIGHTING_PCH__H
#define __REAL_TIME_LIGHTING_PCH__H
...
#include <TupperFilters/Libraries/Plugins/DeleteFaces.h>
#include <TupperFilters/Libraries/Plugins/CopyObjects.h>
