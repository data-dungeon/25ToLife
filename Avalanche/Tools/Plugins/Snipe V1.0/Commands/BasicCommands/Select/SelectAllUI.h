...
class SelectAllCommandUIPlugin : public HCommandUIPluginHelper
{
protected:
    HCommandPlugin *m_pSelectAllCommandPlugin;

public:
   DECLARE_COMMANDUI_PLUGINHELPER(SelectAllCommandUIPlugin, HCommandUIPluginHelper)
