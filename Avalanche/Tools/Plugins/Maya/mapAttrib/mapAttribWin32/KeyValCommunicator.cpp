...
//
// Input:
//	MapAttrController* pObjAttrController -- Pointer back to the object
...
// Output: None
//-----------------------------------------------------------------------------
KeyValCommunicator::KeyValCommunicator(MapAttrController* pObjAttrController, char* pRegKeyName)
{
...
{
	// Tell the MapAttrController to handle this:
	if (m_pObjAttrController != NULL)
