...
CLEAN : 
	...
	-@erase "$(OUTDIR)\MyProperties.exp"
	-@erase "$(OUTDIR)\MyProperties.lib"
	-@erase "..\MyProperties.hxt"
...
# ADD LINK32 ..\..\..\lib\pc\Fileio.lib ..\..\..\lib\pc\Plugin.lib /nologo /subsystem:windows /dll /machine:I386 /out:"..\MyProperties.hxt"
LINK32_FLAGS=..\..\..\lib\pc\Fileio.lib ..\..\..\lib\pc\Plugin.lib /nologo\
 /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)/MyProperties.pdb" /machine:I386\
 /out:"..\MyProperties.hxt" /implib:"$(OUTDIR)/MyProperties.lib" 
LINK32_OBJS= \
	"$(INTDIR)\Entry.obj" \
	"$(INTDIR)\Export.obj" \
...
"..\MyProperties.hxt" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN : 
	...
	-@erase "$(OUTDIR)\MyProperties.exp"
	-@erase "$(OUTDIR)\MyProperties.lib"
	-@erase "$(OUTDIR)\MyProperties.pdb"
	-@erase "..\MyProperties.hxt"
	-@erase "..\MyProperties.ilk"
...
# ADD LINK32 ..\..\..\lib\pc\Fileio.lib ..\..\..\lib\pc\Plugin.lib /nologo /subsystem:windows /dll /debug /machine:I386 /out:"..\MyProperties.hxt"
LINK32_FLAGS=..\..\..\lib\pc\Fileio.lib ..\..\..\lib\pc\Plugin.lib /nologo\
 /subsystem:windows /dll /incremental:yes /pdb:"$(OUTDIR)/MyProperties.pdb" /debug\
 /machine:I386 /out:"..\MyProperties.hxt" /implib:"$(OUTDIR)/MyProperties.lib" 
LINK32_OBJS= \
	"$(INTDIR)\Entry.obj" \
	"$(INTDIR)\Export.obj" \
	"$(INTDIR)\ExportActionsDialog.obj" \
...
ALL : "$(OUTDIR)\MyProperties.hxt" "$(OUTDIR)\MyProperties.trg"
...
# ADD LINK32 ..\..\..\lib\mac\Fileio.lib ..\..\..\lib\mac\Plugin.lib /nologo /mac:nobundle /mac:creator="IE  " /dll /machine:MPPC /out:"pmacrel\MyProperties.hxt"
LINK32_FLAGS=..\..\..\lib\mac\Fileio.lib ..\..\..\lib\mac\Plugin.lib /nologo\
 ...
 /incremental:no /pdb:"$(OUTDIR)/MyProperties.pdb" /machine:MPPC /out:"$(OUTDIR)/MyProperties.hxt"\
 /implib:"$(OUTDIR)/MyProperties.lib" 
LINK32_OBJS= \
	"$(INTDIR)\Entry.obj" \
	"$(INTDIR)\Export.obj" \
	"$(INTDIR)\ExportActionsDialog.obj" \
...
"$(OUTDIR)\MyProperties.hxt" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
...
MFILE32_FILES= \
	"$(OUTDIR)/MyProperties.hxt"

"$(OUTDIR)\MyProperties.trg" : "$(OUTDIR)" $(MFILE32_FILES)
    $(MFILE32) $(MFILE32_FLAGS) .\PMacRel\MyProperties.hxt\
 "$(MFILE32_DEST):MyProperties.hxt">"$(OUTDIR)\MyProperties.trg"
...
# ADD LINK32 ..\..\..\lib\mac\Fileio.lib ..\..\..\lib\mac\Plugin.lib /nologo /mac:nobundle /mac:creator="IE  " /dll /debug /machine:MPPC /out:"pmacdbg\MyProperties.hxt"
LINK32_FLAGS=..\..\..\lib\mac\Fileio.lib ..\..\..\lib\mac\Plugin.lib /nologo\
 /mac:nobundle /mac:type="shlb" /mac:creator="IE  "\
 /mac:init="WlmConnectionInit" /mac:term="WlmConnectionTerm" /dll\
 /incremental:yes /pdb:"$(OUTDIR)/MyProperties.pdb" /debug /machine:MPPC\
 /out:"$(OUTDIR)/MyProperties.hxt" /implib:"$(OUTDIR)/MyProperties.lib" 
LINK32_OBJS= \
	"$(INTDIR)\Entry.obj" \
	"$(INTDIR)\Export.obj" \
	"$(INTDIR)\ExportActionsDialog.obj" \
