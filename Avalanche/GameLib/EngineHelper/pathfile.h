...
public:
	...
	// Do two filenames match (ignore case and slash differences)
	static bool FilenamesMatch(const char* A, const char* B);

	// Compare two filenames (ignore case and slash differences)
	static int FilenameCompare(const char* A, const char* B);
};
