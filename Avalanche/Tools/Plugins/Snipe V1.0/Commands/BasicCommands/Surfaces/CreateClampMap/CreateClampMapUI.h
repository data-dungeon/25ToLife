...
class CreateClampMapCommandUIPlugin : public HCommandUIPluginHelper
{
protected:
     HCommandPlugin *m_pCreateClampMapCommandPlugin;
public:
   DECLARE_COMMANDUI_PLUGINHELPER(CreateClampMapCommandUIPlugin, HCommandUIPluginHelper)
