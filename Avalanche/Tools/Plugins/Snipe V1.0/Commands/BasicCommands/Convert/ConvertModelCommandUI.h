...
class ConvertModelCommandUIPlugin : public HCommandUIPluginHelper
{
protected:
    HCommandPlugin *m_pConvertModelCommandPlugin;

public:
   DECLARE_COMMANDUI_PLUGINHELPER(ConvertModelCommandUIPlugin, HCommandUIPluginHelper)
