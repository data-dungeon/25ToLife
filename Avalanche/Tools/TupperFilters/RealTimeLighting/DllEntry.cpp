...
RealTimeLightingPluginDesc realTimeLightingPluginDesc;
...
{
	return ("Real Time Lighting Filter - Adds Real Time Lighting (i.e Normals) to meshes that need it");
}

// This function returns the number of plug-in classes this DLL
__declspec( dllexport ) FilterPluginDesc* LibPluginDesc(void)
{
	return &realTimeLightingPluginDesc;
}
