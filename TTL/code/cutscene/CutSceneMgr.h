...
extern CCutSceneMgr g_cutSceneManager;
...
public:
	...
	static void DialogStartedCallback( void *context , CommonStreamInterface *stream );
...
//matt	uint d_SaveCameraID;
	char *d_SaveCameraName;
