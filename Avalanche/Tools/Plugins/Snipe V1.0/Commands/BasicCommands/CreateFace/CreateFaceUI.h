...
class CreateFaceCommandUIPlugin : public HCommandUIPluginHelper
{
protected:
     HCommandPlugin *m_pCreateFaceCommandPlugin;
public:
   DECLARE_COMMANDUI_PLUGINHELPER(CreateFaceCommandUIPlugin, HCommandUIPluginHelper)
