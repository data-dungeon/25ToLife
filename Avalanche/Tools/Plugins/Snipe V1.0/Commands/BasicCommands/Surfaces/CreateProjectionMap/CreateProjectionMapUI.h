...
class CreateProjectionMapCommandUIPlugin : public HCommandUIPluginHelper
{
protected:
     HCommandPlugin *m_pCreateProjectionMapCommandPlugin;
public:
   DECLARE_COMMANDUI_PLUGINHELPER(CreateProjectionMapCommandUIPlugin, HCommandUIPluginHelper)
