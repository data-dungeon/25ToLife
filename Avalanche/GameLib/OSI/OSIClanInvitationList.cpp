...
///////////////////////////////////////////////////////////////////////////////////////
/*virtual*/ void OSIClanInvitationList::next()
{
    if (_currentPtr)
    {
...
///////////////////////////////////////////////////////////////////////////////////////
/*virtual*/ void OSIClanInvitationList::previous()
{
    if (_currentPtr)
    {
...
///////////////////////////////////////////////////////////////////////////////////////
/*virtual*/ void OSIClanInvitationList::begin()
{
...
///////////////////////////////////////////////////////////////////////////////////////
/*virtual*/ void OSIClanInvitationList::end()
{
...
///////////////////////////////////////////////////////////////////////////////////////
/*virtual*/ void OSIClanInvitationList::erase()
{
    if (_currentPtr)
    {
...
////////////////////////////////////////////////////////////////////////////////////////
void OSIClanInvitationList::clear( void )
{
...
///////////////////////////////////////////////////////////////////////////////////////
void OSIClanInvitationList::push_front(OSIClanInvitation &data)
{
    if (!_headPtr)
    {
...
/// \param data New item to add to list
///////////////////////////////////////////////////////////////////////////////////////
void OSIClanInvitationList::insert(OSIClanInvitation &data)
{
	listNode* newNode;
...
/// \param data New item to add to list
///////////////////////////////////////////////////////////////////////////////////////
void OSIClanInvitationList::push_back(OSIClanInvitation &data)
{
    if (!_tailPtr)
    {
...
///////////////////////////////////////////////////////////////////////////////////////
/*virtual*/ unsigned long OSIClanInvitationList::count() const
{
    return _count;
}
...
///////////////////////////////////////////////////////////////////////////////////////
OSIClanInvitation *OSIClanInvitationList::getCurrent()
{
    if (_currentPtr)
    {
...
///////////////////////////////////////////////////////////////////////////////////////
const OSIClanInvitation *OSIClanInvitationList::operator[](unsigned long offset)
{
