...
#define EXPORT_DX_PLUGIN_ID	PluginID(0x33177419, 0x52951eaa)

FilterPlugin *ExportDXPluginDesc::Create(TupperChainLogBase &log)
{
	return new ExportDXFilter(log); 
}

PluginID ExportDXPluginDesc::GetPluginID(void)
{
	return EXPORT_DX_PLUGIN_ID; 
}

HINSTANCE ExportDXPluginDesc::HInstance()
{
	return hInstance;
}
