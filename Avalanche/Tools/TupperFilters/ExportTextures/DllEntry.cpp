...
ExportTexturesPluginDesc ExportTexturesPluginDesc;
...
{
	return ("ExportTextures Filter - Read a list of textures and save out a dbl file");
}

// This function returns the number of plug-in classes this DLL
__declspec( dllexport ) FilterPluginDesc* LibPluginDesc(void)
{
	return &ExportTexturesPluginDesc;
}
