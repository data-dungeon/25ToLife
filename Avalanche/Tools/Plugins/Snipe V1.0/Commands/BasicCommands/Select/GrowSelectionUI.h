...
class GrowSelectionCommandUIPlugin : public HCommandUIPluginHelper
{
protected:
    HCommandPlugin *m_pGrowSelectionCommandPlugin;

public:
   DECLARE_COMMANDUI_PLUGINHELPER(GrowSelectionCommandUIPlugin, HCommandUIPluginHelper)
...
class ShrinkSelectionCommandUIPlugin : public HCommandUIPluginHelper
{
protected:
   HCommandPlugin *m_pShrinkSelectionCommandPlugin;

public:
   DECLARE_COMMANDUI_PLUGINHELPER(ShrinkSelectionCommandUIPlugin, HCommandUIPluginHelper)
