...
class AddModifiedMotionCommandUIPlugin : public HCommandUIPluginHelper
{
protected:
    HCommandPlugin *m_pAddModifiedMotionCommandPlugin;

public:
   DECLARE_COMMANDUI_PLUGINHELPER(AddModifiedMotionCommandUIPlugin, HCommandUIPluginHelper)
