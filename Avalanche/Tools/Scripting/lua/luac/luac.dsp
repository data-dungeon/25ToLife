...
# PROP Scc_ProjName ""$/Avalanche/tools/Scripting/lua/luac", LFSAAAAA"
# PROP Scc_LocalPath "."
CPP=cl.exe
RSC=rc.exe
...
# ADD CPP /nologo /W3 /Gm /GX /ZI /Od /I "..\include" /I "..\corelib" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /YX /FD /GZ  /c
...
SOURCE=..\corelib\lopcodes.c

!IF  "$(CFG)" == "luac - Win32 Release"

!ELSEIF  "$(CFG)" == "luac - Win32 Debug"

# ADD CPP /D "LUA_OPNAMES"
