...
LPDISPATCH CStrip::GetBackPicture()
{
	LPDISPATCH result;
...
void CStrip::SetFont(LPFONTDISP propVal)
{
...
LPDISPATCH CStrip::GetTrackBackPicture()
{
	LPDISPATCH result;
...
LPDISPATCH CStrip::GetTrackBandPicture()
{
	LPDISPATCH result;
	GetProperty(0x7c, VT_DISPATCH, (void*)&result);
	return result;
}
