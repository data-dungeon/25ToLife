...
class HideSelectionCommandUIPlugin : public HCommandUIPluginHelper
{
protected:
     HCommandPlugin *m_pHideSelectionCommandPlugin;
public:
   DECLARE_COMMANDUI_PLUGINHELPER(HideSelectionCommandUIPlugin, HCommandUIPluginHelper)
