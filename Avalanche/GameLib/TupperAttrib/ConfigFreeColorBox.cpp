//-----------------------------------------------------------------------------
//	File:		TupConfigFreeColorBox.cpp
//	Created:	Nov. 20, 2001
//				Copyright (c) 2001, Avalanche Software Inc.
//				All Rights Reserved.
//	Author:		Brad Worthen
//
//	Desc:	The TupConfigFreeColorBox class represents the FREE_COLOR_BOX
//			configuration data.
//
...
/*
 * $History: ConfigFreeColorBox.cpp $
 * 
 * *****************  Version 22  *****************
...
//-----------------------------------------------------------------------------
// TupConfigFreeColorBox::TupConfigFreeColorBox
...
//-----------------------------------------------------------------------------
// TupConfigFreeColorBox::BuildConfigTree
...
//-----------------------------------------------------------------------------
bool TupConfigFreeColorBox::BuildConfigTree(TupperwareAggregate *pFreeColorTupAgg,ConfigOverrides &overrides)
{
	bool bSuccess = true;
	...
	{
		// Set the name:
		m_strName = pFreeColorTupAgg->GetName();
...
//-----------------------------------------------------------------------------
// TupConfigFreeColorBox::GetKeyValueContexts
...
//
//-----------------------------------------------------------------------------
void TupConfigFreeColorBox::GetKeyValueContexts(const TupKeyValue &path,TupKeyValueContext &keyValueContext,bool addKeys) const
{
