...
class SaveSelectionCommandUIPlugin : public HCommandUIPluginHelper
{
protected:
     HCommandPlugin *m_pSaveSelectionCommandPlugin;
public:
   DECLARE_COMMANDUI_PLUGINHELPER(SaveSelectionCommandUIPlugin, HCommandUIPluginHelper)
