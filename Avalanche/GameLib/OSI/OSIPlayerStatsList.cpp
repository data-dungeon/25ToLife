#include <stdlib.h>
#include "OSIPlayerStatsList.hpp"
...
///////////////////////////////////////////////////////////////////////////////////////
/*virtual*/ void OSIPlayerStatsList::next()
{
    if (_currentPtr)
    {
...
///////////////////////////////////////////////////////////////////////////////////////
/*virtual*/ void OSIPlayerStatsList::previous()
{
    if (_currentPtr)
    {
...
///////////////////////////////////////////////////////////////////////////////////////
/*virtual*/ void OSIPlayerStatsList::begin()
{
...
///////////////////////////////////////////////////////////////////////////////////////
/*virtual*/ void OSIPlayerStatsList::end()
{
...
///////////////////////////////////////////////////////////////////////////////////////
/*virtual*/ void OSIPlayerStatsList::erase()
{
    if (_currentPtr)
    {
...
////////////////////////////////////////////////////////////////////////////////////////
void OSIPlayerStatsList::clear( void )
{
...
///////////////////////////////////////////////////////////////////////////////////////
void OSIPlayerStatsList::push_front(OSIPlayerStats &data)
{
    if (!_headPtr)
    {
...
/// \param data New item to add to list
///////////////////////////////////////////////////////////////////////////////////////
void OSIPlayerStatsList::insert(OSIPlayerStats &data)
{
	listNode* newNode;
...
/// \param data New item to add to list
///////////////////////////////////////////////////////////////////////////////////////
void OSIPlayerStatsList::push_back(OSIPlayerStats &data)
{
    if (!_tailPtr)
    {
...
///////////////////////////////////////////////////////////////////////////////////////
/*virtual*/ unsigned long OSIPlayerStatsList::count() const
{
    return _count;
}
...
///////////////////////////////////////////////////////////////////////////////////////
OSIPlayerStats *OSIPlayerStatsList::getCurrent()
{
    if (_currentPtr)
    {
...
///////////////////////////////////////////////////////////////////////////////////////
const OSIPlayerStats *OSIPlayerStatsList::operator[](unsigned long offset)
{
...
/// \return Pointer to item (NULL if it doesn't exist).
///////////////////////////////////////////////////////////////////////////////////////
OSIPlayerStats *OSIPlayerStatsList::getPlayerAtIndex(unsigned long offset)
{
    unsigned long count = 0;
    listNode *curPtr = _headPtr;
...
///////////////////////////////////////////////////////////////////////////////////////
OSIPlayerStats* OSIPlayerStatsList::findPlayerByID( OSIPlayerID& id )
{
	listNode *curPtr = _headPtr ;
	if ( curPtr )
	{

		while ( curPtr && curPtr->data.playerID != id )
		{
			curPtr = curPtr->nextPtr ;
		}
		if ( curPtr )
