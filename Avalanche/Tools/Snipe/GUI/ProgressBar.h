...
public:
   ...
   int GetVirtualPos() { return m_nVirtualPos; }//tony
   void SetVirtualPos(int nPos) { m_nVirtualPos = nPos; }//tony
   int GetFactor() { return m_nFactor; }
   void SetFactor(int nFactor) { m_nFactor = nFactor; }
