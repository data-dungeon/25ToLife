...
#ifndef __ANNOTATE_PCH__H
#define __ANNOTATE_PCH__H

// defines for the attribute block headers
#define BEGIN_OBJ_BLOCK	"BEGIN OBJECTATTRIBUTES"
#define END_OBJ_BLOCK	"END OBJECTATTRIBUTES"
#define BEGIN_MAP_BLOCK	"BEGIN MAPATTRIBUTES"
#define END_MAP_BLOCK	"END MAPATTRIBUTES"
...
#include <TupperFilters/Libraries/Plugins/materialimageRefs.h>
#include <TupperFilters/Libraries/Plugins/facecollision.h>
#include <TupperFilters/Libraries/Plugins/makedummymesh.h>
