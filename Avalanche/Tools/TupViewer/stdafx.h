...
#error "Critical error: TupViewer sample requires support for the tabbed control bars"
#endif
...
// Option Tree
#include <MFCControls/COptionTree/resource.h>
#include <MFCControls/COptionTree/OptionTree.h>