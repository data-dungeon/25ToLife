/****************************************************************************
	...
	$Archive: /Avalanche/tools/Plugins/Maya/mapAttrib/pluginMain.cpp $
...
{ 
	...
	status = plugin.registerCommand( "mapAttrib", CPluginMain::creator );
	if (!status) 
	{
...
//
{
	...
	status = plugin.deregisterCommand( "mapAttrib" );
	if (!status) 
	{
