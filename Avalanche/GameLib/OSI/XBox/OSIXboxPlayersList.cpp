...
///////////////////////////////////////////////////////////////////////////////////////
OSIXboxPlayersList::OSIXboxPlayersList() :
    _count(0),
    _currentPtr(NULL),
    _headPtr(NULL),
    _tailPtr(NULL)
...
///////////////////////////////////////////////////////////////////////////////////////
/*virtual*/ void OSIXboxPlayersList::next()
{
    if (_currentPtr)
    {
...
///////////////////////////////////////////////////////////////////////////////////////
/*virtual*/ void OSIXboxPlayersList::previous()
{
    if (_currentPtr)
    {
...
///////////////////////////////////////////////////////////////////////////////////////
/*virtual*/ void OSIXboxPlayersList::begin()
{
...
///////////////////////////////////////////////////////////////////////////////////////
/*virtual*/ void OSIXboxPlayersList::end()
{
...
///////////////////////////////////////////////////////////////////////////////////////
/*virtual*/ void OSIXboxPlayersList::erase()
{
    if (_currentPtr)
    {
...
////////////////////////////////////////////////////////////////////////////////////////
void OSIXboxPlayersList::clear( void )
{
...
///////////////////////////////////////////////////////////////////////////////////////
void OSIXboxPlayersList::push_front(OSIXboxPlayersListItem* data)
{
    if (!_headPtr)
    {
...
/// \param data New item to add to list
///////////////////////////////////////////////////////////////////////////////////////
void OSIXboxPlayersList::insert(OSIXboxPlayersListItem* data)
{
	listNode* newNode;
...
/// \param data New item to add to list
///////////////////////////////////////////////////////////////////////////////////////
void OSIXboxPlayersList::push_back(OSIXboxPlayersListItem* data)
{
    if (!_tailPtr)
    {
...
///////////////////////////////////////////////////////////////////////////////////////
/*virtual*/ unsigned long OSIXboxPlayersList::count() const
{
    return _count;
}
...
///////////////////////////////////////////////////////////////////////////////////////
OSIXboxPlayersListItem *OSIXboxPlayersList::getCurrent()
{
    if (_currentPtr)
    {
...
///////////////////////////////////////////////////////////////////////////////////////
OSIXboxPlayersListItem* OSIXboxPlayersList::operator[](unsigned long offset)
{
