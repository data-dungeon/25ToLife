...
INLINE gsmword Decode_gsm_div (gsmword num, gsmword denum)
{
...
INLINE void DecodeCoefficients_0_12(gsmword * LARpp_j_1, gsmword * LARpp_j, gsmword * LARp)
{
	int 	i;
...
INLINE void DecodeCoefficients_13_26(gsmword * LARpp_j_1, gsmword * LARpp_j, gsmword * LARp)
{
	int i;
...
INLINE void DecodeCoefficients_27_39(gsmword * LARpp_j_1, gsmword * LARpp_j, gsmword * LARp)
{
	int i;
...
INLINE void DecodeCoefficients_40_159(gsmword * LARpp_j, gsmword * LARp)
{
	int i;
                                            ...
                                            gsmword *wt, short *s)
{
	...
	DecodeCoefficients_0_12(LARpp_j_1, LARpp_j, LARp);
	LARp_to_rp(LARp);
	Short_term_synthesis_filtering(S, LARp, 13, wt, s);

	DecodeCoefficients_13_26(LARpp_j_1, LARpp_j, LARp);
	LARp_to_rp(LARp);
	Short_term_synthesis_filtering(S, LARp, 14, wt + 13, s + 13);

	DecodeCoefficients_27_39(LARpp_j_1, LARpp_j, LARp);
	LARp_to_rp(LARp);
	Short_term_synthesis_filtering(S, LARp, 13, wt + 27, s + 27);

	DecodeCoefficients_40_159(LARpp_j, LARp);
	LARp_to_rp(LARp);
