...
#ifndef TUPPERATTRIB_CONFIG_COMBO_BOX_H
#define TUPPERATTRIB_CONFIG_COMBO_BOX_H
...
class TupConfigComboBox : public TupConfigBase
{
	TupString	m_strName;
	int m_nDefaultIndex;
	TupArray<TupConfigSelection*> m_vectComboChildren;
...
public:
	...
	TupConfigBase::ControlType GetControlType(void) const { return TupConfigBase::COMBO_BOX; }
	...
	const TupConfigSelection *GetSelectionChild(int index) const { return m_vectComboChildren[index]; }
