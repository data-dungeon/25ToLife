...
extern const MIDL_STUBLESS_PROXY_INFO IPictureDecoder_ProxyInfo;
...
CINTERFACE_PROXY_VTABLE(9) _IPictureDecoderProxyVtbl = 
{
    ...
    (void *) (INT_PTR) -1 /* IPictureDecoder::LoadPicture */ ,
    (void *) (INT_PTR) -1 /* IPictureDecoder::LoadResPicture */
};
