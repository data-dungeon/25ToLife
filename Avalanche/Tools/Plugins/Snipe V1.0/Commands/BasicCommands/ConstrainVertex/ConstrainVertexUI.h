...
class ConstrainVertexCommandUIPlugin : public HCommandUIPluginHelper
{
protected:
     HCommandPlugin *m_pConstrainVertexCommandPlugin;
public:
   DECLARE_COMMANDUI_PLUGINHELPER(ConstrainVertexCommandUIPlugin, HCommandUIPluginHelper)
