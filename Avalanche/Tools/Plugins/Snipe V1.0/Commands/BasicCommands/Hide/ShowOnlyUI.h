...
class ShowOnlyCommandUIPlugin : public HCommandUIPluginHelper
{
protected:
   HCommandPlugin *m_pShowOnlyCommandPlugin;

public:
   DECLARE_COMMANDUI_PLUGINHELPER(ShowOnlyCommandUIPlugin, HCommandUIPluginHelper)
