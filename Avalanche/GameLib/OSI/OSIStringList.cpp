...
///////////////////////////////////////////////////////////////////////////////////////
/*virtual*/ void OSIStringList::next()
{
    if (_currentPtr)
    {
...
///////////////////////////////////////////////////////////////////////////////////////
/*virtual*/ void OSIStringList::previous()
{
    if (_currentPtr)
    {
...
///////////////////////////////////////////////////////////////////////////////////////
/*virtual*/ void OSIStringList::begin()
{
...
///////////////////////////////////////////////////////////////////////////////////////
/*virtual*/ void OSIStringList::end()
{
...
///////////////////////////////////////////////////////////////////////////////////////
/*virtual*/ void OSIStringList::erase()
{
    if (_currentPtr)
    {
...
///////////////////////////////////////////////////////////////////////////////////////
void OSIStringList::push_front(const OSIchar *data)
{
    if (!_headPtr)
    {
        ...
        OSIstrncpy(_headPtr->data, data, MAX_STRING_LENGTH - 1);
        _headPtr->data[MAX_STRING_LENGTH - 1] = '\0';
    ...
    else
    {
        ...
        OSIstrncpy(_headPtr->prevPtr->data, data, MAX_STRING_LENGTH - 1);
        _headPtr->prevPtr->data[MAX_STRING_LENGTH - 1] = '\0';
...
/// \param data New item to add to list
///////////////////////////////////////////////////////////////////////////////////////
void OSIStringList::push_back(const OSIchar *data)
{
    if (!_tailPtr)
    {
        ...
        OSIstrncpy(_tailPtr->data, data, MAX_STRING_LENGTH - 1);
        _tailPtr->data[MAX_STRING_LENGTH - 1] = '\0';
    ...
    else
    {
        ...
        OSIstrncpy(_tailPtr->nextPtr->data, data, MAX_STRING_LENGTH - 1);
        _tailPtr->nextPtr->data[MAX_STRING_LENGTH - 1] = '\0';
...
///////////////////////////////////////////////////////////////////////////////////////
/*virtual*/ unsigned long OSIStringList::count() const
{
    return _count;
}
...
///////////////////////////////////////////////////////////////////////////////////////
OSIchar *OSIStringList::getCurrent()
{
    if (_currentPtr)
    {
...
///////////////////////////////////////////////////////////////////////////////////////
OSIchar *OSIStringList::operator[](unsigned long offset)
{
