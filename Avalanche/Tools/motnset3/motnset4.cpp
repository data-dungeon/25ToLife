...
int main(int argc, char* argv[])
{
   ...
   if(bExcludeModelBone)
	   printf("Excluding Model Bone");
   else
	   printf("Allowing Model Bone");
...
void SetMotionSetHeaderName( char *pName)
{
	strcpy(glbMotnSet.setHeaderName, pName);
}
...
void printCommands(char *programName)
{
	...
	printf("  -m = don't process model bone (bone zero)\n\r");
