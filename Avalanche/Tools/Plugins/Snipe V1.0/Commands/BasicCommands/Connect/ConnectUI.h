...
class ConnectCommandUIPlugin : public HCommandUIPluginHelper
{
protected:
     HCommandPlugin *m_pConnectCommandPlugin;
public:
   DECLARE_COMMANDUI_PLUGINHELPER(ConnectCommandUIPlugin, HCommandUIPluginHelper)
