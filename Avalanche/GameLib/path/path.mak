...
"SNPS2Debug/PathPCH_SN.obj":
	@echo ProDG Compiling "c:/dev/Avalanche/GameLib/path/PathPCH_SN.cpp"
	$(CC) $(CC_FLAGS) "c:/dev/Avalanche/GameLib/path/PathPCH_SN.cpp" -o $@

LIB: "SNPS2Debug/path.lib"

"SNPS2Debug/path.lib" : $(LD_OBJS)
...
include "SNPS2Debug/PathPCH_SN.d"
