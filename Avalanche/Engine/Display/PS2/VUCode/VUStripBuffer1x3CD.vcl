...
;;;  SaveColor color,qsrc		  * saves (color[x], qsrc[y], 0x1) to output stream (1 == GS reg RGBAQ) (or just [xy]
...
;;;  MAX_LINES				* max # of input lines supported
 ...
 BeginMicrocode "VUStripBuffer1x3CD"
		  InitKernel		1
		  LoadCullMatrix
		  LoadTexMatrices
		  LoadTransformMatrix
 ...
 BeginLoop 
		  ...
		  TransformTexCoords		  finalTex,			0, 3
