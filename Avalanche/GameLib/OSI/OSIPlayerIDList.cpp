...
///////////////////////////////////////////////////////////////////////////////////////
/*virtual*/ void OSIPlayerIDList::next()
{
    if (_currentPtr)
    {
...
///////////////////////////////////////////////////////////////////////////////////////
/*virtual*/ void OSIPlayerIDList::previous()
{
    if (_currentPtr)
    {
...
///////////////////////////////////////////////////////////////////////////////////////
/*virtual*/ void OSIPlayerIDList::begin()
{
...
///////////////////////////////////////////////////////////////////////////////////////
/*virtual*/ void OSIPlayerIDList::end()
{
...
///////////////////////////////////////////////////////////////////////////////////////
/*virtual*/ void OSIPlayerIDList::erase()
{
    if (_currentPtr)
    {
...
////////////////////////////////////////////////////////////////////////////////////////
void OSIPlayerIDList::clear( void )
{
...
///////////////////////////////////////////////////////////////////////////////////////
void OSIPlayerIDList::push_front(OSIPlayerID &data)
{
    if (!_headPtr)
    {
...
/// \param data New item to add to list
///////////////////////////////////////////////////////////////////////////////////////
void OSIPlayerIDList::insert(OSIPlayerID &data)
{
	listNode* newNode;
...
/// \param data New item to add to list
///////////////////////////////////////////////////////////////////////////////////////
void OSIPlayerIDList::push_back(OSIPlayerID &data)
{
    if (!_tailPtr)
    {
...
///////////////////////////////////////////////////////////////////////////////////////
/*virtual*/ unsigned long OSIPlayerIDList::count() const
{
    return _count;
}
...
///////////////////////////////////////////////////////////////////////////////////////
OSIPlayerID *OSIPlayerIDList::getCurrent()
{
    if (_currentPtr)
    {
...
///////////////////////////////////////////////////////////////////////////////////////
const OSIPlayerID *OSIPlayerIDList::operator[](unsigned long offset)
{
