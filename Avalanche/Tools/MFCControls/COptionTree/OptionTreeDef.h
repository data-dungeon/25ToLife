...
// -- List
#define OT_LIST_NUMERICAL					0x00000200L				// Numerical list
#define OT_LIST_ADJUST_COLUMNS			0x00000400L				// Able to adjust columns in the dialog
#endif // !OT_TREEDEF
