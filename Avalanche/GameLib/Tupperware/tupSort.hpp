...
//***************************************************************************
template <class T>
inline void TupSort<T>::SortAscending(
T *list,
int items)
{
...
//***************************************************************************
template <class T>
inline void TupSort<T>::SortDescending(
T *list,
int items)
{
	int lo, hi; 					// ends of sub-array currently sorting
...
//***************************************************************************
template <class T>
inline void TupSort<T>::InsertionSortAscending(
T *list,
int lo,
int hi)
{
...
//***************************************************************************
template <class T>
inline void TupSort<T>::InsertionSortDescending(
T *list,
int lo,
int hi)
{
